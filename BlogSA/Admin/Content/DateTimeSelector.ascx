<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DateTimeSelector.ascx.cs"
    Inherits="Admin_Content_DateTimeSelector" %>
<asp:DropDownList runat="server" ID="ddlDateMonth">
</asp:DropDownList>
,
